...
class OntlastingFragment: Fragment() {

    companion object {
        var STOP_NAME = "stopName"
    }

    private var _binding: OntlastingFragmentBinding? = null
...
//            unit = it.getString("unit").toString()
    ...
    override fun onCreateView(
        ...
        _binding = OntlastingFragmentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                viewModel.insertOntlasting(ontlasting = Ontlasting(id = 0, startdate.text.toString(), ontlasting_text))
